    ...
    <div class="row justify-content-center">
      ...
      <div class="select2-selection--single col-12 col-md-6">
        <div class="input-group">
          <input type="number" inputmode="numeric" pattern="[0-9]*" id="mensualitesConso" name="mensualitesConso" class="form-control form-input col-12" placeholder='Ex : 500' data-type="integer">
      ...
      <div class="select2-selection--single col-12 col-md-6 mt-4">
        <div class="input-group">
          <input type="number" inputmode="numeric" pattern="[0-9]*" id="restantConso" name="restantConso" class="form-control form-input col-12" placeholder='Ex : 5000' data-type="integer">
      ...
      <div class="select2-selection--single col-12 col-md-6 mt-4">
        <div class="input-group">
          <input type="number" inputmode="numeric" pattern="[0-9]*" id="mensualitesImmo" name="mensualitesImmo" class="form-control form-input col-12" placeholder='Ex : 1000' data-type="integer">
          <span class="input-group-text">€/mois</span>
        </div>
      ...
      <div class="select2-selection--single col-12 col-md-6 mt-4">
        <div class="input-group">
          <input type="number" inputmode="numeric" pattern="[0-9]*" id="restantImmo" name="restantImmo" class="form-control form-input col-12" placeholder='Ex : 100000' data-type="integer">
          <span class="input-group-text">€</span>
        </div>
