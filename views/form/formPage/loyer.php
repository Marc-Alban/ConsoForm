    ...
    <div class="step1_1A_project col-12">
      <div class="row">
        ...
        <div class="section-container">
          <div class="row">
            <label for="loyerMensuel" class="col-12 col-md-4 fw-bold text-start labelLoyer">Loyer mensuel :
              <p class="afterLabel">(Hors prêt immobilier)</p>
            </label>
            <div class="col-12 col-md-8">
              <div class="input-group">
                <input type="number" inputmode="numeric" pattern="[0-9]*" id="loyerMensuel" name="loyerMensuel" class="form-control form-input col-11 mask" placeholder='Ex : 1000' data-type="integer">
