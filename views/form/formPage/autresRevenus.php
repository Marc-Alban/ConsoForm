      ...
      <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-8">
              <div class="input-group">
                <input type="number" inputmode="numeric" pattern="[0-9]*" id="revenusLocatifs" name="revenusLocatifs" class="form-control form-input col-11 mask" placeholder='Ex : 800' data-type="integer">
        ...
        <div class="section-container custom-margin">
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-8">
              <div class="input-group">
                <input type="number" inputmode="numeric" pattern="[0-9]*" id="autresRevenusFoyer" name="autresRevenusFoyer" class="form-control form-input col-11 mask" placeholder='Ex : 100' data-type="integer">
                <span class="input-group-text">€/mois</span>
              </div>
        ...
        <div class="section-container custom-margin">
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-8">
              <div class="input-group">
                <input type="number" inputmode="numeric" pattern="[0-9]*" id="allocationsFoyer" name="allocationsFoyer" class="form-control form-input col-11 mask" placeholder='Ex : 100' data-type="integer">
                <span class="input-group-text">€/mois</span>
              </div>
