<!-- Container principal pour la situation professionnelle -->
<div class="container text-center situation_pro tab step" id="6-content">
    ...
    <div class="step1_1A_project col-12">
      <div class="row justify-content-center">
        ...
        <div id="professionContainer" class="col-12 row mb-3 d-none">
          ...
          <div class="select2-selection--single col-md-8 mt-4">
            <input type="text" id="profession" name="profession" class="form-control form-input col-12" placeholder="Champs à remplir" data-type="string" required>
        ...
        <div id="dateDebutContainer" class="col-12 row mb-3 d-none">
          ...
          <div class="select2-selection--single col-md-8 mt-4">
            <div class="input-group">
              <input type="text" id="dateDebut" name="dateDebut" placeholder="JJ/MM/AAAA" class="form-control form-input col-12" data-type="dateFr" required>
  ...
  <div class="btnForm mt-5">
    <div class="row justify-content-center justify-content-md-end">
      ...
      <button type="button" class="btn btn-primary btnNext">Suivant<i class="fas fa-arrow-right"></i>
      </button>
    </div>
  </div>
</div>
